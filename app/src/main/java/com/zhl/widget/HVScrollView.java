...
public class HVScrollView extends FrameLayout {
    ...
    */
     ...
     *                  to <a href="http://lib.csdn.net/base/go" class='replace_word' title="Go知识库" target='_blank' style='color:#df3434; font-weight:bold;'>Go</a> the top of the view or
     *                  {@link android.view.View#FOCUS_DOWN} to <a href="http://lib.csdn.net/base/go" class='replace_word' title="Go知识库" target='_blank' style='color:#df3434; font-weight:bold;'>go</a> the bottom
