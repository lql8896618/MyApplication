 ...
 * 描述：
 */
public class ImageSelector extends ScrollSelector<Bitmap> {
    ...
    private void init(AttributeSet attrs) {
        if (attrs != null) {
            ...
            mDrawMode = typedArray.getInt(
                    R.styleable.ImageSelector_spv_draw_bitmap_mode, mDrawMode);
            mSpecifiedSizeWidth = typedArray.getDimensionPixelOffset(
                    R.styleable.ImageSelector_spv_draw_bitmap_width, mSpecifiedSizeWidth);
            mSpecifiedSizeHeight = typedArray.getDimensionPixelOffset(
                    R.styleable.ImageSelector_spv_draw_bitmap_height, mSpecifiedSizeHeight);
            mMinScale = typedArray.getFloat(R.styleable.ImageSelector_spv_min_scale, mMinScale);
            mMaxScale = typedArray.getFloat(R.styleable.ImageSelector_spv_max_scale, mMaxScale);
            typedArray.recycle();
        }
    }
