 ...
 * 描述：
 */
public class StringSelector extends ScrollSelector<String> {
    ...
    public StringSelector(Context context, AttributeSet attrs) {
    ...
    private void init(AttributeSet attrs) {
        if (attrs != null) {
            TypedArray typedArray = getContext().obtainStyledAttributes(attrs,
                    R.styleable.StringSelector);
            mMinTextSize = typedArray.getDimensionPixelSize(
                    R.styleable.StringSelector_spv_min_text_size, mMinTextSize);
            mMaxTextSize = typedArray.getDimensionPixelSize(
                    R.styleable.StringSelector_spv_max_text_size, mMaxTextSize);
            mStartColor = typedArray.getColor(
                    R.styleable.StringSelector_spv_start_color, mStartColor);
            mEndColor = typedArray.getColor(
                    R.styleable.StringSelector_spv_end_color, mEndColor);
            mMaxLineWidth = typedArray.getDimensionPixelSize(R.styleable.StringSelector_spv_max_line_width, mMaxLineWidth);
            int align = typedArray.getInt(R.styleable.StringSelector_spv_alignment, 1);
            if (align == 2) {
